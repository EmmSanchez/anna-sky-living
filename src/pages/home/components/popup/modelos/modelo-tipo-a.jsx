...
// images carousel
import vista1 from "../../../../../assets/images/modelos/vista1.svg";
  ...
  return (
    <div className="fixed top-0 z-50 w-full h-full bg-azul overflow-y-auto">
      <div className="relative w-full flex flex-col items-center p-[60px] gap-[20px]">
        ...
        {/* Imagenes */}
        <div className="flex shrink-0 justify-between gap-[10px] w-full h-[573px] border"></div>
      ...
      <div className="relative w-full h-[800px]">
        {/* overlay */}
        <div className="absolute z-10 inset-0 w-full h-full bg-linear-to-b from-azul to-[37%] to-azul/0" />
        <img src={vista1} alt="" className="absolute inset-0 w-full h-full" />
      </div>
    </div>
  );
}
