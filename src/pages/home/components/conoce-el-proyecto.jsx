      ...
      <div className="flex flex w-full max-w-[1280px] justify-center items-center py-[60px] gap-[40px]">
        ...
        <div className="flex flex-col w-[620px] gap-[30px]">
          <div className="flex flex-col gap-[15px]">
            <h2 className="text-[35px] text-gris font-bangla uppercase leading-[120%] tracking-wide">
              Conoce el proyecto
            </h2>
          ...
          <div className="flex">
            {caracteristicas.map((caracteristica, index) => {
              return (
                <div
                  key={index}
                  className={`flex flex-col justify-center items-center w-[207px] py-[20px] px-[15px] gap-[15px] ${index === 1 ? "border-none" : "border-x-2 border-amarillo"}`}
                >
                  <img src={caracteristica.icon} alt="" />
                  <h4 className="text-[21px] text-negro font-bold uppercase leading-none">
                    {caracteristica.label}
                  </h4>
                  <p className="text-[21px] text-center text-negro font-light leading-[120%]">
        ...
        {/* Right panel */}
        <div className="relative w-[555px] h-[800px]">
          <img
            src={conoceImage}
            alt="Anna Sky Living"
